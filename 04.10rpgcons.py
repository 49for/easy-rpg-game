...
def meetPeople():
    ...
    peopleLvl = r.randint(2,5)
    peopleHp = peopleLvl
    peopleDmg = peopleLvl *2 - 1
    peoples = ['Rober', 'Asassin', 'Burglar']

    people = r.choice(peoples)

    print("Ты набрел на грабителя у него {1} уровень, {2} жизней и {3} урона." .format(people, peopleLvl, peopleHp, peopleDmg)
    printParameters()
